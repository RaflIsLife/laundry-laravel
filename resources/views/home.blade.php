    ...
    <div class="container-fluid p-0">
        ...
        <div class="container py-5">
            ...
            <div class="row align-items-center mb-5 mt-5">
                <div class="col-md-6">
                    ...
                    <p class="text-muted">
                        Kami menghadirkan layanan laundry berkualitas dengan pencucian higienis dan perawatan maksimal. Pakaian Anda akan selalu bersih, segar, dan nyaman dikenakan setiap hari.
                    </p>
                </div>
                <div class="col-md-6">
            ...
            <div class="row align-items-center mb-5 mt-5">
                <div class="col-md-6 order-md-2">
                    ...
                    <p class="text-muted">
                        Hemat waktu dengan layanan laundry kilat dan antar-jemput. Kami memastikan pakaian bersih dan rapi dalam waktu singkat tanpa mengurangi kualitas.
                    </p>
                </div>
            ...
            <div class="row align-items-center mb-5 mt-5" style="background-image: url(image/home/c3.webp); background-position: right; background-size: cover; height: 560px;">
                <div class="col-md-6" >
                    <h2 class="display-5 fw-bold mb-4">
                        Perawatan<br>
                    ...
                    <p class="text-muted">
                        Setiap jenis kain membutuhkan perawatan berbeda. Dari pakaian harian hingga bahan sensitif, kami menggunakan metode terbaik.
                    </p>
                </div>
                <div class="col-md-6">
                    {{-- <img src="image/home/c3.webp" alt="Laundry Service" class=" rounded card-img" style="size: 100px"> --}}
                </div>
            </div>
            ...
            <div class="row align-items-center mb-5 mt-5">
                <div class="col-md-6 order-md-2">
                    ...
                    <p class="text-muted">
                        Laundry berkualitas tak harus mahal. Dengan harga bersahabat, kami memastikan pakaian Anda tetap bersih, wangi, dan siap pakai kapan saja.
                    </p>
                </div>
                <div class="col-md-6 order-md-1" style="border-radius: 100px; display: flex; overflow: hidden;">
        ...
        <div class="text-white py-5">
            <div class="container">
                <div class="row g-4 align-content-between justify-content-between">
                    <div class="col-md-4 text-center text-black-50 card pb-5 hover-card-blue" style="border-radius: 20px; background-color: rgba(195, 232, 250, 0.651); width: 31%;">
        ...
        <div class="container my-5 py-5 text-center">
            ...
            <div class="row g-4 align-content-between justify-content-between mt-4">
                <div class="col-md-4 text-center text-black-50 card pb-5 hover-card-blue" style="border-radius: 20px; background-color: rgba(195, 232, 250, 0.651); width: 23%; height: 300px;">
                    ...
                    <p class="">Pakaian Anda dicuci dengan hati-hati menggunakan deterjen berkualitas, sehingga tetap bersih, wangi, dan terjaga keawetannya.</p>
                </div>
                <div class="col-md-4 text-center text-black-50 card pb-5 hover-card-blue" style="border-radius: 20px; background-color: rgba(195, 232, 250, 0.651); width: 23%; height: 300px;">
                    ...
                    <p class="">Kami mengeringkan pakaian dengan metode yang aman, sehingga pakaian tetap lembut dan tidak rusak.</p>
                </div>
                <div class="col-md-4 text-center text-black-50 card pb-5 hover-card-blue" style="border-radius: 20px; background-color: rgba(195, 232, 250, 0.651); width: 23%; height: 300px;">
                    ...
                    <p class="">Kami menyetrika pakaian dengan rapi dan halus, siap digunakan untuk setiap kesempatan tanpa kusut</p>
                </div>
                <div class="col-md-4 text-center text-black-50 card pb-5 hover-card-blue" style="border-radius: 20px; background-color: rgba(195, 232, 250, 0.651); width: 23%; height: 300px;">
                    ...
                    <p class="">Pakaian yang telah dicuci dan disetrika kami lipat dengan rapi agar lebih praktis saat disimpan</p>
                </div>
