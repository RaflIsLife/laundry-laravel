...
class CreateTransaksisTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('transaksis', function (Blueprint $table) {
            ...
            $table->enum('status', ['menunggu pembayaran', 'menunggu pengambilan', 'menunggu pengantaran', 'pengambilan', 'antrian laundry', 'Proses laundry', 'pengantaran', 'menunggu user mengambil', 'selesai', 'dibatalkan']);
